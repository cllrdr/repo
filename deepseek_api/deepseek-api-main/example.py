...
def main():
    try:
        ...
        api = DeepSeekAPI("tMH2DtSTzxDLgU/yxOzQzSnMrZfDUIUogML8iUBf0fdPPMkWV99jWJeCP6lbdcMg")
        ...
        run_chat_example(
            ...
            "Напиши структуру для презентации на 5 слайдов по теме: особенности семейных ценностей в России",
            thinking_enabled=True
        )
